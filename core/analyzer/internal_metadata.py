...
VENDOR_PATTERNS = {
    "HP": [rb"HP", rb"ProBook", rb"EliteBook", rb"Pavilion"],
    "Dell": [rb"Dell", rb"Alienware", rb"Latitude", rb"Vostro", rb"Inspiron"],
    "Lenovo": [rb"Lenovo", rb"ThinkPad", rb"IdeaPad", rb"Legion"],
    "ASUS": [rb"ASUS", rb"ROG", rb"ZenBook", rb"VivoBook"],
    "Acer": [rb"Acer", rb"Aspire", rb"Nitro", rb"Predator"],
    "Samsung": [rb"Samsung"],
    "Sony": [rb"Sony", rb"VAIO"],
    "Toshiba": [rb"Toshiba", rb"Dynabook"],
    "MSI": [rb"MSI"],
    "Gigabyte": [rb"Gigabyte", rb"AORUS"]
}
